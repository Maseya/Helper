...
namespace Maseya.Controls
{
    ...
    /// <summary>
    /// References a method to be called that will preprocess a <see
    /// cref="Message"/> before it is used in <see cref="Control. WndProc(ref
    /// Message)"/> or <see cref="Control. DefWndProc(ref Message)"/>.
    /// </summary>
    /// <param name="m">
