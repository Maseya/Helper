...
namespace Maseya.Helper.PixelFormat
{
    ...
    /// drawing. For 32-bit ARGB bitmaps, its pixel buffer pointer can
    /// be cast to type <see cref="Color32BppArgb"/>* for simplified
    /// color operations.
    /// </remarks>
    ...
    {
        /// <summary>
        /// The size, in bytes, of the <see cref="Color32BppArgb"/> data
        /// type.
        /// </summary>
        ...
        /// Color32BppArgb"/> struct with given red, green, and blue
        /// intensities. The alpha component is set to max, representing
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="
        /// Color32BppArgb"/> struct with given alpha, red, green, and
        /// blue intensities.
        /// </summary>
        /// <param name="alpha">
        /// The alpha intensity.
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="
        /// Color32BppArgb"/> struct from a 32-bit integer value.
        /// </summary>
        /// <param name="value">
        ...
        /// <summary>
        /// Gets or sets the full 32-bit integer value representing this
        /// <see cref="Color32BppArgb"/>'s ARGB components.
        /// </summary>
        public int Value
        {
            get
        ...
        /// <summary>
        /// Creates a <see cref="Color32BppArgb"/> with a specified
        /// <see cref="Value"/> parameter.
        /// </summary>
        /// <param name="value">
        /// The <see cref="Value"/> parameter to use for this
        /// <see cref="Color32BppArgb"/> instance.
        /// </param>
        /// <returns>
        ...
        /// <summary>
        /// Creates a <see cref="Color32BppArgb"/> structure whose
        ...
        /// </param>
        /// <returns>
        /// A <see cref="Color32BppArgb"/> whose
        /// <see cref="Alpha"/>, <see cref="Red"/>, <see cref="Green"/>,
        /// and <see cref="Blue"/> properties are equal to a <see cref="
        /// Color"/>'s <see cref="Color.A"/>, <see cref="Color.R"/>,
        /// <see cref="Color.G"/>, and <see cref="Color.B"/> properties,
        ...
        /// cref="Color32BppArgb"/>'s <see cref="Alpha"/>, <see cref="
        ...
        /// cref="Color32BppArgb"/>'s <see cref="Alpha"/>, <see cref="
        /// Red"/>, <see cref="Green"/>, and <see cref="Blue"/>
        /// properties, respectively of <paramref name="color32"/>.
        /// </returns>
        ...
        /// <see cref="Alpha"/>, <see cref="Red"/>, <see cref="Green"/>,
        /// and <see cref="Blue"/> properties are equal to a <see cref="
        /// ColorF"/>'s <see cref="ColorF.Alpha"/>, <see cref="ColorF.
        /// Red"/>, <see cref="ColorF.Green"/>, and <see cref="ColorF.
        /// Blue"/> properties, respectively.
        /// </summary>
        /// <param name="colorF">
        ...
        /// ColorF"/>'s <see cref="ColorF.Alpha"/>, <see cref="ColorF.
        /// Red"/>, <see cref="ColorF.Green"/>, and <see cref="ColorF.
        /// Blue"/> properties, respectively of <paramref name="
        /// colorF"/>.
        /// </returns>
        ...
        /// ColorF.Green"/>, and <see cref="ColorF.Blue"/> properties
        /// are equal to a <see cref="Color32BppArgb"/>'s <see cref="
        /// Alpha"/>, <see cref="Red"/>, <see cref="Green"/>, and <see
        /// cref="Blue"/> properties, respectively.
        /// </summary>
        /// <param name="color32">
        /// The <see cref="Color32BppArgb"/> to convert.
        /// </param>
        ...
        /// are equal to a <see cref="Color32BppArgb"/>'s <see cref="
        /// Alpha"/>, <see cref="Red"/>, <see cref="Green"/>, and <see
        /// cref="Blue"/> properties, respectively of <paramref name="
        /// color32"/>.
        /// </returns>
        ...
        /// Blue"/> properties of the two <see cref="Color32BppArgb"/>
        /// are equal.
        /// </summary>
        /// <param name="left">
        ...
        /// a specified <see cref="Color32BppArgb"/> value.
        /// </summary>
        /// <param name="obj">
        /// A <see cref="Color32BppArgb"/> value to compare to this
        /// instance.
        /// </param>
        /// <returns>
        ...
        /// instance of <see cref="Color32BppArgb"/> and equals the
        ...
        /// Color32BppArgb"/> object to its equivalent string
        /// representation.
        /// </summary>
        /// <returns>
